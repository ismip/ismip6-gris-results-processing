...
while [ $counter -lt ${count} ]; do
	...
	ncatted -a _FillValue,lithk,o,d,NaN ${anc}
	ncatted -a _FillValue,lithk,o,d,0. ${anc}
	ncatted -a _FillValue,lithk,d,, ${anc}

	anc=${apath}/orog_GIS_${labs[$counter]}_${models[$counter]}_${exp}.nc
	# fix missing value flag
	ncatted -a _FillValue,orog,o,d,NaN ${anc}
	ncatted -a _FillValue,orog,o,d,0. ${anc}
	ncatted -a _FillValue,orog,d,, ${anc}
	
	anc=${apath}/topg_GIS_${labs[$counter]}_${models[$counter]}_${exp}.nc
	# fix missing value flag
	ncatted -a _FillValue,topg,o,d,NaN ${anc}
	ncatted -a _FillValue,topg,o,d,-4000. ${anc}
