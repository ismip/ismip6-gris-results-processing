...
while [ $counter -lt ${count} ]; do
	...
	../scalars_basin.sh $flg_GICmask $flg_OBSmask ${ares}
	...
	[ -f ./scalars_mm_${ares}.nc ] && /bin/mv ./scalars_mm_${ares}.nc ${destpath}/scalars_mm_GIS_${labs[$counter]}_${models[$counter]}_${exp}.nc
	[ -f ./scalars_rm_${ares}.nc ] && /bin/mv ./scalars_rm_${ares}.nc ${destpath}/scalars_rm_GIS_${labs[$counter]}_${models[$counter]}_${exp}.nc
	[ -f ./scalars_zm_${ares}.nc ] && /bin/mv ./scalars_zm_${ares}.nc ${destpath}/scalars_zm_GIS_${labs[$counter]}_${models[$counter]}_${exp}.nc
	#/bin/rm model.nc
    done
    # end exp loop
