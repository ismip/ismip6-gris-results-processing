...
## labs list
#declare -a labs=(ILTS_PIK ILTS_PIK AWI AWI AWI MUN UCIJPL JPL JPL)
## models list
#declare -a models=(SICOPOLIS2 SICOPOLIS3 ISSM1 ISSM2 ISSM3 GSM2371 ISSM ISSM ISSMPALEO)

## labs list
#declare -a labs=(AWI AWI AWI MUN UCIJPL)
## models list
#declare -a models=(ISSM1 ISSM2 ISSM3 GSM2371 ISSM)
